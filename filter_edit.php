...
<?php
	...
	print '<form action="general-submit.php" method="post"><input name="option" value="filteredit" hidden>';
	
	print '<div class="'.$tablebackground_nolines_header.'" style="max-width:800px; min-width:600px; padding:0px;">
	   		<div class="customfont" align="center">Edit Filter</div></div>
...
?>
	...
	<td align="right"><a href="filter_form.php"><button class="btn btn-default" type="button">CANCEL</button></a></td>
	</table>
	</form>
		</div>
	</body>
